...
ALTER TABLE "user_custom_keywords" ADD CONSTRAINT "user_custom_keywords_profile_id_profiles_profile_id_fk" FOREIGN KEY ("profile_id") REFERENCES "public"."profiles"("profile_id") ON DELETE cascade ON UPDATE no action;